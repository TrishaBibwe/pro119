...
function preload(){
    classifier=ml5.imageclassifier("Doodlellet");
}
...
function draw(){
    ...
    if (mouseIsPressed){
        line(pmousex, pmouseY, mousex, HouseY);
...
function setup(){
    ...
    canvas.center();
    background("white");
    canvas.BOusekeleased(Classifycanvas);
}
...
function gotResults(error,results){
    ...
    console. log(results);
    tobedrawn=results[0].label;
    document.getElementById("yoursketch").innerHTML="Your Sketch: "+results[0]. label;
    document.getElementById("confidence"). innertHTML="Confidence: "+Math.round(results[0].confidence*100)+'%';
